...
import {MealsOnDate, UserDetail} from "../../types/userDetail";
...
export default function UserPage(userDetail: UserDetail) {
  ...
  return (<div className={styles.userInfoContainer}>
    <div className={styles.userSummaryContainer}>
      <UserSummaryCard user={authContext.userInfo} mostRecentDay={mostRecentDay}
                       mostRecentDayMeal={mealsOfMostRecentDay}/>
    </div>
