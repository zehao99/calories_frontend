  ...
  return <div className={styles.todayMenuItemContainer}>
    ...
    <div className={styles.todayMenuItemInput}>
      ...
      <InputNumber value={amount} size="middle" formatter={formatter} ref={inputRef}
                   style={{display: "inline", width: "60px", margin: "0 0.7rem"}}
                   onChange={event => changeValueHandler(event)}/>
      <FontAwesomeIcon icon="minus" width="14" height="14"
                       onClick={amount > 1 ? props.decreaseItemHandler.bind(this, props.fdc_id) : () => {
                       }}
